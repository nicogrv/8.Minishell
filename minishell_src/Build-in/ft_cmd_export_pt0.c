...
/*   Updated: 2023/03/27 21:42:16 by pbizien          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../_Include/minishell.h"

void	ft_ok_export_bis(char *str, int i, char *var, t_env *tmp)
{
...
int	ft_ok_export(char *str, t_data *data, char **cmd_quotes)
{
	t_env	*tmp;
	char	*var;
	int		i;
...
int	ft_plus_egal_export(char *str, t_data *data, char **cmd_quotes)
{
	t_env	*tmp;
	char	*var;
	int		i;
